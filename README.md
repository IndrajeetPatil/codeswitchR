...
| data wrangling + analysis | `dplyr`       | `SQL`                        | `dbplyr`     | <img src="examples/dplyr_sql.jpeg" width="1016" />       |
| data wrangling + analysis | `SQL`         | `dplyr`                      | `tidyquery`  | <img src="examples/sql_dplyr.jpeg" width="912" />        |
